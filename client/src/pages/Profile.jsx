...
//     handleSubmit(new Event('submit'), section);
//   };
...
//             />
//             {isEditing.general ? (
//               <button type="button" onClick={() => handleSaveClick('general')} className="bg-green-500 text-white p-3 rounded-md hover:bg-green-600">
//                 Save Changes
//               </button>
//             ) : (
//               <button
...
//                 className="bg-navy-blue text-white p-3 rounded-md hover:bg-navy-blue-dark"
//               >
//                 Edit General
//               </button>
//             )}
...
//             </div>
//             {isEditing.account ? (
//               <button type="button" onClick={() => handleSaveClick('account')} className="bg-green-500 text-white p-3 rounded-md hover:bg-green-600">
//                 Save Changes
//               </button>
//             ) : (
//               <button
